...
ScrollText	    		db	"PERYFERiAH kLAN pROUDLY pRESENT : MetaProducts Startup Organizer 2.9.324 [SR6] *kEyGeN.OnLy by r0ger* :: Rls date: 19.apr.2o24 :: "
						db  "Protection: RSA-370 :: Music by Icefall :: Greetz 2 all PRF memberz and all the teams listed "
						db  "in the aboutbox. See the nfo or open up the nfo viewer for more details.                                                              "
						db  "                                              now look at this archive that i just found ... when i say 'go!' , be ready "
						db  "to download... and GO ! :3)                                                  ",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,1
		mov scr.scroll_y,267
		
		mov scr.scroll_width,418
