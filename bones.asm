...
LOCAL ps:PAINTSTRUCT
	...
	.if [uMessg] == WM_INITDIALOG
		...
		invoke ImageButton,xWnd,21,233,600,602,601,IDB_ABOUT
		mov hAbout,eax
		invoke ImageButton,xWnd,216,233,700,702,701,IDB_EXIT
		mov hExit,eax
	...
	.elseif [uMessg] == WM_PAINT
		...
		invoke CreateSolidBrush,008D8D8Dh
	...
	.elseif [uMessg] == WM_COMMAND
		...
		.if eax == IDB_ABOUT
			...
			invoke DialogBoxParam,0,IDD_ABOUT,0,addr AboutProc,0
